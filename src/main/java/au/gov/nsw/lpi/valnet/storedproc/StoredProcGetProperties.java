...
/**
 * Calls get_properties stored procedure
 * @author matkinson
 *
 */

@Component
public class StoredProcGetProperties extends StoredProcedure {

	transient Logger logger = Logger.getLogger(getClass());

	private static final String SQL = "vn_web_services.get_properties";

	@Autowired
	public StoredProcGetProperties(DataSource ds) {
		
		/*
		 logger.info("*** getProperties instantiate");
		*/
	...
	public Map execute(RequestControl model) {
		...
		logger.info("*** Stored proc getProperties execute " + model.getXRef());
